  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested micro_post" do
        ...
        MicroPost.any_instance.should_receive(:update_attributes).with({ "user_id" => "MyString" })
        put :update, {:id => micro_post.to_param, :micro_post => { "user_id" => "MyString" }}, valid_session
      end
